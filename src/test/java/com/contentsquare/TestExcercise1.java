...
public class TestExcercise1 {
    ...
    public void setUp() {
        ...
        try {
            ...
            System.setProperty("webdriver.chrome.driver","C:\\Users\\NAYAANI\\javapoc\\chromedriver.exe");
    ...
    public void testTextUnderShadowRoot() {
        ...
        login.checkLoginScreen(driver);
        login.clickAccount(driver);
        login.enterLoginDetailsAndClick(driver);
        login.loginScreenError(driver);
    }
}